...
const UsageGuide = ({ onClose }) => {
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="glass-white p-4 rounded-lg">
            ...
            <div className="glass-white rounded-xl shadow-md p-6">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                ...
                <ul className="text-sm text-yellow-700 space-y-1">
                  <li>• <strong>MiniMax</strong> - {t('guide.minimaxHint', language)}</li>
                  <li>• <strong>OpenAI</strong> - {t('guide.openaiHint', language)}</li>
                  <li>• <strong>Claude</strong> - {t('guide.claudeHint', language)}</li>
                </ul>
              </div>
            ...
            <div className="glass-white rounded-xl shadow-md p-6">
              ...
              <div className="space-y-3">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">{t('guide.minimaxModel', language)}</p>
                  <p className="text-xs text-gray-500 mt-1">{t('guide.minimaxAdvantage', language)}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-bold text-gray-800">OpenAI</h4>
                  <p className="text-sm text-gray-600">{t('guide.openaiModel', language)}</p>
                  <p className="text-xs text-gray-500 mt-1">{t('guide.openaiAdvantage', language)}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-bold text-gray-800">Claude</h4>
                  <p className="text-sm text-gray-600">{t('guide.claudeModel', language)}</p>
                  <p className="text-xs text-gray-500 mt-1">{t('guide.claudeAdvantage', language)}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="glass-white rounded-xl shadow-md p-6">
              ...
              <div className="space-y-3">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-bold text-gray-800">{t('guide.topicExample1', language)}</h4>
                  <p className="text-xs text-gray-500 mt-1">{t('guide.topicExample1Desc', language)}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-bold text-gray-800">{t('guide.topicExample2', language)}</h4>
                  <p className="text-xs text-gray-500 mt-1">{t('guide.topicExample2Desc', language)}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-bold text-gray-800">{t('guide.topicExample3', language)}</h4>
                  <p className="text-xs text-gray-500 mt-1">{t('guide.topicExample3Desc', language)}</p>
                </div>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="glass-white rounded-2xl shadow-2xl max-w-5xl w-full max-h-[90vh] flex flex-col">
        {/* 头部 */}
        <div className="bg-gradient-to-r from-blue-500 to-purple-500 text-white p-6 rounded-t-2xl flex-shrink-0">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-2xl font-bold">{t('guide.aiTitle', language)}</h2>
              <p className="text-blue-100 text-sm mt-1">{t('guide.aiSubtitle', language)}</p>
            </div>
            <button
              onClick={onClose}
        ...
        {/* 次级标签导航 */}
        <div className="glass-white border-b border-gray-200 px-6 py-3 flex-shrink-0">
